...
- 素材名称：前端实时视频流首页截图（2026-04-27）
  - 来源依据：`docs/records/frontend_video_home_2026-04-27.png`
  - 建议内容：左上角真实视频流、中央执行流、右侧控制区的完整首屏状态
  - 当前状态：已留档
  - 论文用途：系统实现与验证、前端工作台展示、答辩展示
- 素材名称：前端任务运行中截图（2026-04-27）
  - 来源依据：`docs/records/frontend_video_running_2026-04-27.png`
  - 建议内容：自然语言指令提交后的阶段推进、事件日志与运行状态
  - 当前状态：已留档
  - 论文用途：运行过程说明、前后端联调证据
- 素材名称：前端任务完成态截图（2026-04-27）
  - 来源依据：`docs/records/frontend_video_completed_2026-04-27.png`
  - 建议内容：视频流持续在线、任务终态、assistant_response 与事件日志收口
  - 当前状态：已留档
  - 论文用途：闭环结果展示、系统实现与验证
- 素材名称：左上角视频流特写（2026-04-27）
  - 来源依据：`docs/records/frontend_video_panel_2026-04-27.png`
  - 建议内容：相机输入画面特写，便于论文中单独展示感知输入区域
  - 当前状态：已留档
  - 论文用途：感知层实现说明、界面局部放大图
- 素材名称：汉诺塔任务 skill 流程图
  - 来源依据：`docs/specs/13-hanoi-task-skill.md`、`src/embodied_agent/skills/hanoi.py`
  - 建议内容：汉诺塔目标、合法约束、递归拆解步骤与中文原子指令的关系图
  - 当前状态：已具备代码与规范依据，可直接出图，尚未绘制
  - 论文用途：复杂任务技能扩展示例、长程任务规划说明
